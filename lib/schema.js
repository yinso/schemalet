...
(function() {
  var AndConstraint, AppError, ArraySchema, BooleanSchema, Constraint, EnumConstraint, IntegerSchema, MapSchema, MaxItemsConstraint, MaxLengthConstraint, MaximumConstraint, MinItemsConstraint, MinLengthConstraint, MinimumConstraint, MultipleOfConstraint, NullSchema, NumberSchema, ObjectSchema, OneOfSchema, PatternConstraint, ProcedureSchema, Promise, Schema, SchemaEnv, SchemaPath, StringSchema, TupleSchema, UniqueItemsConstraint, _extend,
    slice = [].slice,
  ...
  SchemaPath = (function() {
    function SchemaPath(path1, prev1) {
      this.path = path1 != null ? path1 : '';
      this.prev = prev1 != null ? prev1 : null;
    }
  ...
  Schema = (function() {
    function Schema(schema1, prev1) {
      ...
      if (this.schema.hasOwnProperty('default')) {
        this.validate(this.schema["default"]);
      }
      ...
      if (this.isOptional()) {
        this.defaultVal = (function(_this) {
          return function() {
            if (_this.schema.hasOwnProperty('defaultProc')) {
              return _this.schema.defaultProc.apply(_this, arguments);
            } else if (_this.schema.hasOwnProperty('default')) {
              return _this.schema["default"];
            }
          };
        })(this);
      }
    ...
    Schema.prototype.convert = function(v, schemaPath) {
      ...
      if ((v === null || v === void 0) && this.schema.hasOwnProperty('default')) {
    ...
    Schema.makeClass = function(schema) {
      var Ctor, Parent, innerCtor, key, name, ref, schemaObj, val;
      name = schema.hasOwnProperty('id') ? schema.id : 'SchemaClass';
      schemaObj = schema instanceof Schema ? schema : this.makeSchema(schema);
      innerCtor = schema.hasOwnProperty('$ctor') ? schema.$ctor : function(res) {
        var key, results, val;
        results = [];
        for (key in res) {
          val = res[key];
      ...
      if (schema.hasOwnProperty('$prototype') && (schema.$prototype instanceof Object)) {
  ...
  ArraySchema = (function(superClass) {
    ...
    ArraySchema.prototype.toJSON = function() {
      var res;
      res = ArraySchema.__super__.toJSON.call(this);
      res.items = this.item.toJSON();
      return res;
    };
  ...
  TupleSchema = (function(superClass) {
    ...
    TupleSchema.prototype.toJSON = function() {
      var item, res;
      res = TupleSchema.__super__.toJSON.call(this);
      res.items = (function() {
        var k, len, ref, results;
        ref = this.items;
        results = [];
  ...
  ObjectSchema = (function(superClass) {
    ...
    function ObjectSchema(schema, prev) {
      ...
      if (ProcedureSchema.prototype.isFunction(schema.$ctor)) {
        this.$ctor = schema.$ctor;
      }
    }
    ...
    ObjectSchema.prototype.toJSON = function() {
      ...
      res = ObjectSchema.__super__.toJSON.call(this);
      res.properties = {};
      ref = this.properties;
      for (k = 0, len = ref.length; k < len; k++) {
  ...
  MapSchema = (function(superClass) {
    ...
    MapSchema.prototype.toJSON = function() {
      var res;
      res = MapSchema.__super__.toJSON.call(this);
  ...
  OneOfSchema = (function(superClass) {
    ...
    OneOfSchema.prototype.toJSON = function() {
  ...
  ProcedureSchema = (function(superClass) {
    ...
    ProcedureSchema.prototype.isFunction = function(v) {
    ...
    ProcedureSchema.prototype.extractCallback = function(args) {
      ...
      if (this.arity.min === this.arity.max) {
        if (args.length === this.arity.min) {
          return [args, void 0];
        } else if (args.length > this.arity.min && this.isFunction(args[args.length - 1])) {
        ...
        return [args, void 0];
      } else if (!this.isFunction(args[args.length - 1])) {
        return [args, void 0];
      } else {
        cb = args[args.length - 1];
        return [args.slice(0, args.length - 1), cb];
      ...
      normalized = (function() {
        ...
        for (i = k = 0, len = args.length; k < len; i = ++k) {
          ...
          if (i < this.params.length) {
            normed = !param.isRequired() && arg === void 0 ? param.defaultVal() : arg;
