...
(function() {
  var AllOfSchema, AndConstraint, AppError, ArraySchema, BooleanSchema, Constraint, EnumConstraint, IntegerSchema, MapSchema, MaxItemsConstraint, MaxLengthConstraint, MaximumConstraint, MinItemsConstraint, MinLengthConstraint, MinimumConstraint, MultipleOfConstraint, NullSchema, NumberSchema, ObjectSchema, OneOfSchema, PatternConstraint, ProcedureSchema, Promise, Schema, SchemaEnv, SchemaPath, StringSchema, TupleSchema, UniqueItemsConstraint, _extend,
    slice = [].slice,
  ...
  Schema = (function() {
    ...
    Schema.makeClass = function(schema) {
      ...
      innerCtor = schema.hasOwnProperty('$init') ? schema.$init : function(res) {
        var key, results, val;
        results = [];
        for (key in res) {
          val = res[key];
  ...
  NullSchema = (function(superClass) {
    ...
    NullSchema.prototype.toJSON = function() {
  ...
  AllOfSchema = (function(superClass) {
    ...
    AllOfSchema.prototype.toJSON = function() {
      return this.schema;
    };
